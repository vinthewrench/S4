...
S4Crypto is an extensive cross platform library of cryptographic functions that can be called from the C API. It was designed to be portable, such that it can be cross-compiled for different architectures, including OS X, IOS, Linux, Android, and Windows.
	...
	s.source_files = [
		...
		'src/main/S4/s4keysinternal.h',
		'libs/tommath/tommath.h',
		'libs/tommath/tommath_class.h',
		'libs/tommath/tommath_superclass.h',
		'libs/tomcrypt/headers/tomcrypt.h',
		'libs/tomcrypt/headers/tomcrypt_custom.h',
		'libs/tomcrypt/headers/tomcrypt_math.h',
		'libs/tomcrypt/headers/tomcrypt_prng.h',
		'libs/tomcrypt/headers/tomcrypt_argchk.h',
		'libs/tomcrypt/headers/tomcrypt_hash.h',
		'libs/tomcrypt/headers/tomcrypt_misc.h',
		'libs/tomcrypt/headers/tomcrypt_cfg.h',
		'libs/tomcrypt/headers/tomcrypt_mac.h',
		'libs/tomcrypt/headers/tomcrypt_pk.h',
		'libs/tomcrypt/headers/tomcrypt_cipher.h',
		'libs/tomcrypt/headers/tomcrypt_macros.h',
		'libs/tomcrypt/headers/tomcrypt_pkcs.h',
		'libs/sha3/KeccakHash.h',
		'libs/sha3/KeccakP-1600-reference.h',
		'libs/sha3/KeccakSpongeWidth1600.h',
		'libs/sha3/align.h',
		'libs/sha3/KeccakP-1600-SnP.h',
		'libs/sha3/KeccakSponge-common.h',
		'libs/sha3/SimpleFIPS202.h',
		'libs/sha3/brg_endian.h',
		'libs/argon2/argon2.h',
		'libs/argon2/blake2.h',
		'libs/argon2/blamka-round-ref.h',
		'libs/argon2/encoding.h',
		'libs/argon2/thread.h',
		'libs/argon2/blake2-impl.h',
		'libs/argon2/blamka-round-opt.h',
		'libs/argon2/core.h',
		'libs/argon2/ref.h',
		'libs/tomcrypt/hashes/skein/brg_endian.h',
		'libs/tomcrypt/hashes/skein/skeinApi.h',
		'libs/tomcrypt/hashes/skein/threefishApi.h',
		'libs/tomcrypt/hashes/skein/brg_types.h',
		'libs/tomcrypt/hashes/skein/skein_iv.h',
		'libs/tomcrypt/hashes/skein/skein.h',
		'libs/tomcrypt/hashes/skein/skein_port.h',
		'libs/xxHash/xxhash.h',
		'libs/yajl/src/yajl_alloc.h',
		'libs/yajl/src/yajl_bytestack.h',
		'libs/yajl/src/yajl_lex.h',
		'libs/yajl/src/yajl_buf.h',
		'libs/yajl/src/yajl_encode.h',
		'libs/yajl/src/yajl_parser.h',
		'libs/yajl/src/api/yajl_common.h',
		'libs/yajl/src/api/yajl_gen.h',
		'libs/yajl/src/api/yajl_parse.h',
		'libs/yajl/src/api/yajl_tree.h',
		'libs/jsmn/jsmn.h',
		'src/main/S4/s4.c',
