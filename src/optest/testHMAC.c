...
S4Err TestHMAC()
{
    ...
    kdfvector kdf_vector  =
           { "KDF",
            ...
            "\x30\x31\x32\x33\x34\x35\x36\x37\x38\x39\x3a\x3b\x3c\x3d\x3e\x3f\x40\x41\x42\x43",
             "label-1",
            "context-1",
			   {0x12, 0x8C, 0x23, 0x5B, 0x43, 0xE9, 0xFB, 0x01,
				   0x3D, 0x35, 0x9E, 0xF5, 0xDD, 0x96, 0xBF, 0x82,
				   0xFA, 0xE1, 0x0C, 0xA0 },
            
			   { 0x55, 0xBF, 0xE6, 0x8B, 0xF8, 0x31, 0xE8, 0xE7,
				   0x07, 0x66, 0x0A, 0xA6, 0xC3, 0xB3, 0x7B, 0x46,
				   0x47, 0xAA, 0x03, 0x8B, 0xA7, 0x11, 0x33, 0xD0,
				   0xBC, 0x98, 0xE2, 0xBF                       },
            
			   { 0xA7, 0xF7, 0x02, 0xEF, 0x47, 0xA7, 0x2F, 0x9C,
				   0x06, 0xA0, 0xD2, 0x25, 0x7B, 0x22, 0xFF, 0x63,
				   0x60, 0xC8, 0xF8, 0x3A, 0x68, 0xD0, 0xBA, 0xD9,
				   0x56, 0x37, 0x5B, 0x61, 0x0C, 0x05, 0x37, 0x84 },
            
			   { 0x4E, 0x7E, 0x15, 0x9F, 0x88, 0x4B, 0x42, 0x15,
				   0xD7, 0x85, 0x7B, 0x94, 0x76, 0xDE, 0xA3, 0x2E,
				   0xBD, 0xD7, 0x13, 0x8C, 0x89, 0x3B, 0xFB, 0x1B,
				   0x52, 0xE3, 0x1A, 0x93, 0xC6, 0x3F, 0xBF, 0x3C,
				   0x44, 0xEA, 0xE6, 0x6C, 0xD6, 0x0E, 0x96, 0x38,
				   0xF0, 0xCD, 0x69, 0x5A, 0xA5, 0x83, 0xE8, 0xD7 },
            
			   { 0xAF, 0x52, 0x1F, 0x7F, 0x49, 0xFB, 0x52, 0x6B,
				   0xFD, 0xDF, 0x79, 0x37, 0x8E, 0x06, 0xDE, 0x22,
				   0x47, 0x2A, 0xCA, 0xFA, 0xA4, 0x57, 0x4E, 0x3F,
				   0xF7, 0x04, 0xEB, 0x63, 0x7E, 0xA8, 0xAF, 0xE6,
				   0x85, 0xFA, 0xAC, 0x05, 0x32, 0x37, 0xEE, 0x65,
				   0xF0, 0xAE, 0x2D, 0x2D, 0xD6, 0xDC, 0x9E, 0xA0,
				   0x2C, 0x05, 0x8D, 0x15, 0xE1, 0x98, 0xAA, 0xA1,
				   0x52, 0xA6, 0xFE, 0xC0, 0x42, 0xFA, 0x8B, 0xD5 },
            
			   {   0x77, 0x26, 0x70, 0x34, 0x70, 0x13, 0x30, 0xDD,
				   0x53, 0x11, 0x1E, 0xFB, 0xCB, 0x4D, 0x4B, 0x72,
				   0x92, 0xC5, 0x36, 0x4A, 0xA5, 0x52, 0x6E, 0x3E,
				   0xD8, 0x87, 0x71, 0xDD, 0x0B, 0x18, 0x42, 0xD1 },
    ...
    for (i = 0; hash_algor_list[i] != kHASH_Algorithm_Invalid; i++)
    {
        ...
        size_t expectedLen = hash_algor_bits(hash) >>3;
