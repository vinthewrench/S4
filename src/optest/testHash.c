	...
	{
		{
			...
			0,
			1,
			(uint8_t*)"\xDA\x39\xA3\xEE\x5E\x6B\x4B\x0D\x32\x55\xBF\xEF\x95\x60\x18\x90\xAF\xD8\x07\x09",
			20
		},
...

		{
			...
			0,
			1,
			(uint8_t*)"\xD1\x4A\x02\x8C\x2A\x3A\x2B\xC9\x47\x61\x02\xBB\x28\x82\x34"
		...
		},
		{
			...
			0,
			1,
			(uint8_t*)"\xE3\xB0\xC4\x42\x98\xFC\x1C\x14\x9A\xFB\xF4\xC8\x99\x6F\xB9\x24"
		...
		},
		{
			...
			0,
			1,
			(uint8_t*)"\x38\xB0\x60\xA7\x51\xAC\x96\x38\x4C\xD9\x32\x7E\xB1\xB1\xE3\x6A"
		...
		},
		{
			...
			0,
			1,
			(uint8_t*)"\xCF\x83\xE1\x35\x7E\xEF\xB8\xBD\xF1\x54\x28\x50"
			"\xD6\x6D\x80\x07\xD6\x20\xE4\x05\x0B\x57\x15\xDC\x83\xF4\xA9"
			"\x21\xD3\x6C\xE9\xCE\x47\xD0\xD1\x3C\x5D\x85\xF2\xB0\xFF\x83"
			"\x18\xD2\x87\x7E\xEC\x2F\x63\xB9\x31\xBD\x47\x41\x7A\x81\xA5"
			"\x38\x32\x7A\xF9\x27\xDA\x3E",
			64
		},
		{
			kHASH_Algorithm_SHA512,
...

		{
			...
			1,
			(uint8_t*)
			"\xC8\x87\x70\x87\xDA\x56\xE0\x72"
			"\x87\x0D\xAA\x84\x3F\x17\x6E\x94"
			"\x53\x11\x59\x29\x09\x4C\x3A\x40"
			"\xC4\x63\xA1\x96\xC2\x9B\xF7\xBA",
			32
		},
...

		{
			...
			1,
			(uint8_t*)
			"\xBC\x5B\x4C\x50\x92\x55\x19\xC2"
			"\x90\xCC\x63\x42\x77\xAE\x3D\x62"
			"\x57\x21\x23\x95\xCB\xA7\x33\xBB"
			"\xAD\x37\xA4\xAF\x0F\xA0\x6A\xF4"
			"\x1F\xCA\x79\x03\xD0\x65\x64\xFE"
			"\xA7\xA2\xD3\x73\x0D\xBD\xB8\x0C"
			"\x1F\x85\x56\x2D\xFC\xC0\x70\x33"
			"\x4E\xA4\xD1\xD9\xE7\x2C\xBA\x7A",
			64
		},
		{
			kHASH_Algorithm_SKEIN512,
		...
		},
		{
			...
			1,
			(uint8_t*)
			"\x0F\xFF\x95\x63\xBB\x32\x79\x28"
			"\x92\x27\xAC\x77\xD3\x19\xB6\xFF"
			"\xF8\xD7\xE9\xF0\x9D\xA1\x24\x7B"
			"\x72\xA0\xA2\x65\xCD\x6D\x2A\x62"
			"\x64\x5A\xD5\x47\xED\x81\x93\xDB"
			"\x48\xCF\xF8\x47\xC0\x64\x94\xA0"
			"\x3F\x55\x66\x6D\x3B\x47\xEB\x4C"
			"\x20\x45\x6C\x93\x73\xC8\x62\x97"
			"\xD6\x30\xD5\x57\x8E\xBD\x34\xCB"
			"\x40\x99\x15\x78\xF9\xF5\x2B\x18"
			"\x00\x3E\xFA\x35\xD3\xDA\x65\x53"
			"\xFF\x35\xDB\x91\xB8\x1A\xB8\x90"
			"\xBE\xC1\xB1\x89\xB7\xF5\x2C\xB2"
			"\xA7\x83\xEB\xB7\xD8\x23\xD7\x25"
			"\xB0\xB4\xA7\x1F\x68\x24\xE8\x8F"
			"\x68\xF9\x82\xEE\xFC\x6D\x19\xC6",
			128
		},
		{
			kHASH_Algorithm_SKEIN1024,
...

		{
			...
			0,
			1,
			(uint8_t*)"\xEF\x17\x9B\x92\xA2\xFD\x75\xAC",
			8
		},
		...
		},
		{
			...
			1,
			(uint8_t*)
			"\xC5\xD2\x46\x01\x86\xF7\x23\x3C"
			"\x92\x7E\x7D\xB2\xDC\xC7\x03\xC0"
			"\xE5\x00\xB6\x53\xCA\x82\x27\x3B"
			"\x7B\xFA\xD8\x04\x5D\x85\xA4\x70",
			32
		},
