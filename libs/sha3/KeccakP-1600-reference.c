...
static void fromBytesToWords(tKeccakLane *stateAsWords, const unsigned char *state)  __attribute__((unused));
static void fromWordsToBytes(unsigned char *state, const tKeccakLane *stateAsWords) __attribute__((unused)) ;
